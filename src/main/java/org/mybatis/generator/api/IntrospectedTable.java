...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_MYBATIS3_OBJECT_MAPPER_TYPE,
    ...
    public String getObjectRecordType(){
    	return internalAttributes.get(InternalAttribute.ATTR_OBJECT_RECORD_TYPE);
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setBaseResultMapId("BaseResMap"); //$NON-NLS-1$
    ...
    protected void calculateJavaClientAttributes() {
        ...
        sb.setLength(0);
        sb.append(fullyQualifiedTable.getDomainObjectName());
        setMyBatis3ObjectMapperType(sb.toString());
    ...
    protected void calculateModelAttributes() {
        ...
        sb.setLength(0);
        sb.append(fullyQualifiedTable.getDomainObjectName());
        setObjectRecordType(sb.toString());
	...
	public void setObjectRecordType(String objectRecordType) {
		internalAttributes.put(InternalAttribute.ATTR_OBJECT_RECORD_TYPE,
				objectRecordType);
	}
    ...
    public String getMyBatis3ObjectMapperType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_OBJECT_MAPPER_TYPE);
    }

    public void setMyBatis3ObjectMapperType(String mybatis3ObjectMapperType) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_OBJECT_MAPPER_TYPE,
                mybatis3ObjectMapperType);
    }
